            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Box maxWidth={1280} sx={{ width: '100%', p: 1, display: 'flex', flexDirection: 'column' }}>
                    {orgDomains.map((domain, index) => {
                        return <Box key={domain.id} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'left', gap: 1, my: 2, border: '1px solid #abc', p: 2, borderRadius: 3 }}>
