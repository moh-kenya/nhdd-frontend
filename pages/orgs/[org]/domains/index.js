        ...
        <>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minHeight: '85vh' }}>
                ...
                {filteredData.length > 0 ? (
                    <Box maxWidth={1280} sx={{ width: '70%', p: 1 }}>
                        <Grid container spacing={2}>
                            {filteredData.map((domain, index) => (
                                <Grid item key={domain.id} xs={6} md={6} lg={6}>
                                    <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', gap: 1, border: '1px solid #abc', p: 2, borderRadius: 3, backgroundColor: '#F5F5F5' }}>
