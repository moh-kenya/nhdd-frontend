...
import { Box, Drawer, Typography, Toolbar, Divider, List, ListItem, ListItemButton, ListItemText, AppBar, Pagination, Select, MenuItem, InputLabel, TextField, Button, Search, Menu, TableContainer, TableHead, TableBody, Table, TableRow, TableCell } from '@mui/material';
                                ...
                                {isLoadingConcepts ? <Box sx={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    ...
                                    <>
                                        {currentConcepts && currentConcepts.length > 0 ? (<Box>
                                            ...
                                            <Divider />
                                            <Box sx={{ maxHeight: { xs: 'auto', md: '70vh' }, overflowY: 'auto' }}>
                                                <TableContainer>
                                                    <Table>
                                                        <TableHead>
                                                            <TableRow>
                                                                ...
                                                                <TableCell sx={{ fontWeight: 'bold', textTransform: 'uppercase' }}>UUID</TableCell>
                                                                <TableCell sx={{ fontWeight: 'bold', textTransform: 'uppercase' }}>Version</TableCell>
                                                            </TableRow>
                                                        </TableHead>
                                                        <TableBody>
                                                            {currentConcepts?.filter(c => c.type == 'Concept')?.map((concept, index) => (
                                                                <TableRow key={concept.id} sx={{
